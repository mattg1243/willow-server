...
INSERT INTO clients (
  ...
  $1, $2, $3, $4, $5
) RETURNING id, user_id, fname, lname, email, balance, balancenotifythreshold, rate, isarchived, created_at, update_at
`
...
SELECT id, user_id, fname, lname, email, balance, balancenotifythreshold, rate, isarchived, created_at, update_at
FROM clients
WHERE id = $1
`
